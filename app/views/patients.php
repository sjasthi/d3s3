		...
		<ul class="navbar-nav ml-auto">
			<li class="nav-item d-flex align-items-center mr-3">
				<div class="custom-control custom-switch theme-switch">
					<input type="checkbox" class="custom-control-input" id="themeTogglePatients" data-theme-toggle />
					<label class="custom-control-label" for="themeTogglePatients">Dark mode</label>
				</div>
			</li>
			<li class="nav-item">
